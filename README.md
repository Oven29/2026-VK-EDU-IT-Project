...
---
Для реализации архитектурного подхода **DDD** (Domain-Driven Design) мы разобьем систему **WayPost** на независимые бизнес-области, а затем опишем критический сценарий через **BDD** (Behavior-Driven Development).
